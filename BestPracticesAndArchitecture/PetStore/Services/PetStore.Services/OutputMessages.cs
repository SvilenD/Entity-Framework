namespace PetStore.Services
{
    ...
    {
        public const string BrandAlreadyExists = "Brand name {0} already exists.";
        public const string InvalidBrand = "Invalid Brand Name";
        public const string BreedAlreadyExists = "Breed name {0} already exists.";
        public const string InvalidBreed = "Invalid Breed Name";
